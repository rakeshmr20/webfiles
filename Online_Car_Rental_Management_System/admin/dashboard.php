...
?>
													...
													<div class="stat-panel-title text-uppercase">ContactUS Queries</div>
												</div>
											</div>
...
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($query);?></div>
													<div class="stat-panel-title text-uppercase">Drivers</div>
												</div>
											</div>
											<a href="drivers.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
